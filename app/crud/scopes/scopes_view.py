...
from app.crud.scopes import ScopesRepository
from app.crud.oauth import get_current_user
from app.db import PostgresRepository
from app.crud.users import UserDB


scopes_router = APIRouter()

repository = ScopesRepository(connection=PostgresRepository())
services = None
...
def create_scopes(
    ...
    """
    feedback = services.insert(scope)
